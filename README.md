...
Although this is not a bad practice, I just wanted a way to do it easier so instead of having to find my iPad and manually write everything down, which can be a bit annoying sometimes, why not create a solution where I can do it on the most used object daily that I have: my iPhone.
